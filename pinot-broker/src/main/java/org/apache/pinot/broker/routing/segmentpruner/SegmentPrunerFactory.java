    ...
    if (routingConfig != null) {
      ...
      if (segmentPrunerTypes != null) {
        ...
        for (String segmentPrunerType : segmentPrunerTypes) {
          ...
          if (RoutingConfig.TIME_RANGE_SEGMENT_PRUNER_TYPE.equalsIgnoreCase(segmentPrunerType)) {
            TimeRangeSegmentPruner timeRangeSegmentPruner = getTimeRangeSegmentPruner(tableConfig, propertyStore);
            if (timeRangeSegmentPruner != null) {
              segmentPruners.add(timeRangeSegmentPruner);
            }
          }
        }
